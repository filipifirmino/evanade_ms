...
public class OrderConfirmedPublisherUnitTests
{
    ...
    public void Publish_WithValidMessage_ShouldCallServicePublish()
    {
        ...
        _mockRabbitMqService.Verify(
            x => x.Publish("inventory-stock-update-confirmed", message),
            Times.Once);
    }
    ...
    public void Publish_WithServiceException_ShouldPropagateException()
    {
        ...
        var exception = Assert.Throws<Exception>(() => _publisher.Publish(message));
    ...
    public void Publish_MultipleMessages_ShouldCallServicePublishForEach()
    {
        ...
        _mockRabbitMqService.Verify(
            x => x.Publish("inventory-stock-update-confirmed", It.IsAny<StockUpdateConfirmedEvent>()),
            Times.Exactly(3));
    }
    ...
    public void Publish_ShouldUseCorrectQueueName()
    {
        ...
        _mockRabbitMqService.Verify(
            x => x.Publish(It.Is<string>(s => s != "inventory-stock-update-confirmed"), It.IsAny<StockUpdateConfirmedEvent>()),
            Times.Never);
    }
    ...
    public void Publish_WithServiceTimeout_ShouldPropagateException()
    {
        ...
        var exception = Assert.Throws<TimeoutException>(() => _publisher.Publish(message));
    ...
    public void Publish_WithInvalidOperationException_ShouldPropagateException()
    {
        ...
        var exception = Assert.Throws<InvalidOperationException>(() => _publisher.Publish(message));
    ...
    public void Publish_WithArgumentException_ShouldPropagateException()
    {
        ...
        var exception = Assert.Throws<ArgumentException>(() => _publisher.Publish(message));
    ...
    public async Task Publish_WithConcurrentCalls_ShouldCallServicePublishForEach()
    {
        ...
        var tasks = messages.Select(message => Task.Run(() => _publisher.Publish(message)));
    ...
    public void Publish_ShouldMaintainMessageIntegrity()
    {
        ...
        _publisher.Publish(originalMessage);
